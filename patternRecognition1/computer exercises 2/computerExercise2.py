...
# Some data for testing functions
testdata_row = [
            [1, 4, 7, 8],
            [2, 2, 8, 4],
            [1, 13, 1, 5]]
...
##############################################
# Computer exercise 2- needed functions
##############################################
...
##############################################
# Computer exercise 2- b
##############################################
from copy import deepcopy

# Prepare data for computer exercise 2-b
# Make a copy of classes and just keep feature x1
# of samples.
useFirstNfeature = 1
...
# Make a copy of data and just keep feature x1
dataFx1 = deepcopy(data)
for index, x in enumerate(dataFx1):
    dataFx1[index] = x[0:useFirstNfeature]
# Because of classifying  w1 and w2, just use w1 and w2 samples
dataFx1 = dataFx1[0:20]

# Priories of classes
priories = {'w1':0.5, 'w2':0.5, 'w3':0}
...
print("Computer exercises 2-b:")
print("Error: ",
      empirical_training_error(classesFx1,predictByclassifier))


##############################################
# Computer exercise 2- c
##############################################
print('Bhattacharyya bound for w1 & w2:{:f}\n'.format(
      bhattacharyya_bound(normalDists[classOrder['w1']], normalDists[classOrder['w2']])))

##############################################
# Computer exercise 2- d
##############################################
from copy import deepcopy

# Prepare data for computer exercise 2-d
# Make a copy of classes and just keep features x1,x2
# of samples.
useFirstNfeature = 2
...
##############################################
# Computer exercise 2- e
##############################################
from copy import deepcopy

# Prepare data for computer exercise 2-e
# Make a copy of classes keep features x1,x2,x3
# of samples.
useFirstNfeature = 3
...
# testing
##############################################
# Test function covariance_matrix
#print(covariance_matrix(testdata_col))

# Test function mean_vector
#print(mean_vector(testdata_col))
