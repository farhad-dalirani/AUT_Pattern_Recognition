...
##############################################
# Computer exercise 4- needed functions from computer exercise 2
##############################################
...
for useFirstNfeature in range(1,4):
    ...
    dataFx1 = dataFx1[10:30]

    # Priories of classes
    priories = {'w1': 0, 'w2': 0.5, 'w3': 0.5}
    ...
    print("Computer exercises 4 (Features {}):".format(printFeatures[useFirstNfeature-1]))
    print("Error: ",
          empirical_training_error(classesFx1,predictByclassifier))

    print('Bhattacharyya bound for w1 & w4:{:f}\n'.format(
          bhattacharyya_bound(normalDists[classOrder['w2']], normalDists[classOrder['w3']])))
